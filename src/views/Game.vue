<template>
  <div> 
    ...
    <div class="app">
      ...
      <span>([Team one good points , Team one bad points, Team two good points, Team two bad points]) </span> <br><br>
      <span> current hints : {{ currentHints }} </span> 
      <span v-if="isMyTurn"> Your team's turn </span> <br v-if="isMyTurn">


      <span v-if="hinter"> You are the hinter for this round. Give three hints: </span> 
      ...
      <button v-if="isMyTurn && hinter && !hintsSubmitted" @click="submitHints"> submit hints </button> <br>
      ...
      <button v-if="isMyTurn && !submitted && !hinter && guessSubmitted" @click="submitAnswer"> final answer submit </button> 
      <span v-if="!guessSubmitted && isMyTurn"> Other team must guess first </span><br>


      <input v-if="!isMyTurn" v-model="finalGuess" placeholder="final guess">
